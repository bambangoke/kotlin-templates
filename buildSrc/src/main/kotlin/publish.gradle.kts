        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/bambangoke/kotlintemplates/")
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/bambangoke/kotlintemplates.git")
                        developerConnection.set("scm:git:ssh://github.com/bambangoke/kotlintemplates.git")
                        url.set("https://github.com/bambangoke/kotlintemplates/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/bambangoke/kotlintemplates/issues")
                    }
                }
            }
        }
